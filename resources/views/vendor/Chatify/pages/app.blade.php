...
<div class="messenger">
        ...
        <div class="m-body contacts-container">
            ...
            <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                ...
                <p style="text-align: center;color:grey;margin-top:30px">
                    <a target="_blank" style="color:{{$messengerColor}};" href="https://chatify.munafio.com/notes#groups-feature">Cliquez ici</a>pour plus d'informations!
                </p>
            </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            <span class="ic-connected">Liée</span>
