...
<div class="row">
    <div class="col-md-12">
        <a href="{{route('front.profiles')}}"><button style="width: 100%;  background-color: {{ request()->is('front/profiles') ? '#df314d' : '#3a1965' }}; text-align: left" class="lab-btn">Match parfait<span class="myspan1">{{$match}}</span></button></a>
    </div>
    <div class="col-md-12">
        <a href="{{route('front.dashboard')}}"><button style="width: 100%;  background-color: {{ request()->is('dashboard') ? '#df314d' : '#3a1965' }}; text-align: left"  class="lab-btn"  >Activities <span class="myspan1">{{$activities}}</span></button></a>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <a href="{{route('front.notification')}}"><button style="width: 100%;  background-color:{{ request()->is('my/profile') ? '#df314d' : '#3a1965' }}; text-align: left" class="lab-btn">Notification <span class="myspan1 " > 0</span></button></a>
    </div>
    <div class="col-md-12">
        <button style="width: 100%;  background-color: #3a1965; text-align: left" class="lab-btn">Messages <span class="myspan1"> 5</span> </button>
    </div>
    <div class="col-md-12">
        <a href="{{route('front.myactivity')}}"><button style="width: 100%;  background-color:{{ request()->is('my/profile') ? '#df314d' : '#3a1965' }}; text-align: left" class="lab-btn">Mon activité <span class="myspan1"> {{$authactivity}}</span></button></a>
    </div>
    <div class="col-md-12">
