    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <form action="{{route('admin.sorties.store')}}" method="post"  enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <form>
                                            ...
                                            <div class="widget-content widget-content-area">
                                                ...
                                                <div class="form-group mb-4 mt-5">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nom du Sortie" name="name" required>
                                                </div>
                                                <div class="col">
