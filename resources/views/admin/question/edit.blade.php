                                    ...
                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-12 col-lg-12 col-md-12" >
                                                ...
                                                <input type="text"  placeholder="Des questions" name="q" class="form-control" id="q" value="{{$question->q}}">
                                            </div>
                                            <div class="col-xxl-12 col-md-6 mb-4" style="margin-top: 20px;">
                                                <label for="proCode">Réponse 1</label>
                                                <input type="text" placeholder="Réponse 1"  name="a1" class="form-control" id="a1" value="{{$question->a1}}">
                                            </div>
                                            <div class="col-xxl-12 col-md-6 mb-4" style="margin-top: 20px;">
                                                <label for="proSKU">Réponse 2</label>
                                                <input type="text" placeholder="Réponse 2" name="a2" class="form-control" id="a2" value="{{$question->a2}}">
                                            </div>
                                            <div class="col-xxl-12 col-md-6 mb-4" style="margin-top: 20px;">
                                                <label for="proSKU">Réponse 3</label>
                                                <input type="text" placeholder="Réponse 3" name="a3" class="form-control" id="a3" value="{{$question->a3}}">
                                            </div>
                                            <div class="col-xxl-12 col-md-6 mb-4" style="margin-top: 20px;">
                                                <label for="proSKU">Réponse 4</label>
                                                <input type="text" placeholder="Réponse 4" name="a4" class="form-control" id="a4" value="{{$question->a4}}">
                                            </div>
