                            ...
                            <div class="col-md-12">
                                <div class="animated-underline-content">
                                    <ul class="nav nav-tabs" id="animateLine" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="animated-underline-preferences-tab" data-bs-toggle="tab" href="#animated-underline-preferences" role="tab" aria-controls="animated-underline-preferences" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> loisirs</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " id="animated-underline-activities-tab" data-bs-toggle="tab" href="#animated-underline-activities" role="tab" aria-controls="animated-underline-activities" aria-selected="true"> Activities</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="pro-plan layout-spacing">
                                                <div class="widget">
                                                    ...
                                                    <div class="widget-content">
                                                        <ul class="p-2 ps-3 mb-4">{{$plan->description}}
