                                    ...
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="widget-content widget-content-area blog-create-section">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text"  placeholder="Image/URL" style="width: 70%" name="link4"/>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-sm-6 " >
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text"  placeholder="Image/URL"  style="width: 70%" name="link5" />
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-sm-6 " >
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="Image/URL" style="width: 70%" name="link6"/>
                                                </div>
                                                <div class="col-xxl-12 col-sm-4 col-12 mx-auto mt-5">
                                                    <button class="btn btn-success w-100">Mettre à jour le curseur </button>
                                                </div>
